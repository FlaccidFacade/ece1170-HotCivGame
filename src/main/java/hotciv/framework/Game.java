...
public interface Game {
   ...
   * @param agingStrategy
   */
  void setAgingStrategy(AgingStrategy agingStrategy);

  /**
   * //TODO
   * @param winningStrategy
   */
  void setWinningStrategy(WinningStrategy winningStrategy);

  /**
   * //TODO
   * @param actionStrategy
   */
  void setActionStrategy(ActionStrategy actionStrategy);

  /**
   * //TODO
   * @param battlerStrategy
   */
  void setBattleStrategy(BattleStrategy battlerStrategy);
   ...
   * @param t
   */
  void placeTileAt(Position p, Tile t);
   ...
   * @param u
   */
  void placeUnitAt(Position p, Unit u);
   ...
   * @param c
   */
  void placeCityAt(Position p, City c);
